...
- same-node orphaned-active retry should normally be gated by the committed `child_runtime_status_from_launch_result_ref(...)` surface rather than ad hoc log-age guesses in chat
