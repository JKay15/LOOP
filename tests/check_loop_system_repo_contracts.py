    ...
    try:
        _require_text(
            ...
            [
                ...
                "scrub parent `CODEX_*` session/transport env vars",
                "disable OTEL exporters",
                "must not end the root conversation",
                "document refs observed from committed logs",
        ...
        _require_text(
            ...
            [
                ...
                "LoopChildProgressSnapshot.schema.json",
                "LoopChildSupervisionResult.schema.json",
                "child_runtime_status_from_launch_result_ref",
                "child_progress_snapshot_from_launch_result_ref",
                "bootstrap_first_implementer_from_endpoint",
                "supervise_child_until_settled",
        ...
        _require_text(
            ...
            [
                ...
                "runtime_closure",
                "must not become delegated reviewer/test_ai/ai_user lanes",
        ...
        _require_text(
            ...
            [
                ...
                "child_progress_snapshot_from_launch_result_ref",
                "disable OTEL exporters",
                "single `pid_alive=false` observation",
                "must not end the root conversation",
                "document refs observed in committed logs",
            ],
        )
        _require_text(
            ROOT / "docs/contracts/LOOP_SYSTEM_EVENT_JOURNAL_CONTRACT.md",
            [
                ...
                "initialized_at",
                "fail closed",
                "unsupported committed-event schema versions",
                "compatibility mirror",
                "projection seq",
                "explicit rebuild surface",
                "commit-before-projection crash",
                "topology replay",
                "blocking reason",
                "projection-consistency view",
                "commit-state view",
                "structured incompatibility reports",
                "ProjectionManifest.json",
                "covered node set",
                "atomically_visible",
                "projection-explanation surface",
                "applied/pending committed event tail",
                "node-scoped explicit rebuild surface",
                "kernel projection is stale",
                "source_event_journal_ref",
                "projection_bundle_ref",
                "operational hygiene observations",
                "heavy-object observations",
                "operational hygiene view",
                "runtime_reap_requested",
                "runtime_reap_deferred",
                "runtime_reap_confirmed",
                "housekeeping runtime root",
            ],
        )
        _require_text(
